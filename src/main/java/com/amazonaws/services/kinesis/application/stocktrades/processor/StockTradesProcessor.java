...
package com.amazonaws.services.kinesis.application.stocktrades.processor;
...
import com.amazonaws.services.kinesis.application.stocktrades.utils.ConfigurationUtils;
import com.amazonaws.services.kinesis.application.stocktrades.utils.CredentialUtils;
...
public class StockTradesProcessor {
    ...
    private static final Logger PROCESSOR_LOGGER =
            Logger.getLogger("com.amazonaws.services.kinesis.application.stocktrades.processor");
